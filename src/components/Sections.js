...
export function Header({style=""}) {
  return (
    <section className={`w-full h-screen relative ${style}`}>
      <video playsInline autoPlay muted loop id="myVideo" poster='https://firebasestorage.googleapis.com/v0/b/forex-copier-trade.appspot.com/o/app_img%2Fstock-graph.jpg?alt=media&token=aa5ea75f-639a-4f29-9f4b-1b3825acfb8d' className='w-full h-full object-cover'>
  ...
  return (
    <Section style="border-b-2 prose max-w-none">
      ...
      <div className="mt-6 lg:mt-12 mx-auto">
        ...
        <article className="mt-20 lg:mt-0 lg:mx-6">
